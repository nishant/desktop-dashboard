...
// 24 cols, dynamic rowHeight (fills screen), margin=[8,8], containerPadding=[8,8]
// Every preset is mathematically gap-free — all 24×N cells are covered by exactly one widget.
// Designed for 22 rows (fills 1920×1080 at rowHeight≈40).
//
...
export const PRESETS: NamedLayout[] = [
  {
    // x:0-7:  Weather(h=10) + Hardware(h=12) = 22
    // x:8-15: Spotify(h=10) + Hardware(h=12) = 22
    // x:16-23: Stocks(h=10) + Sound(h=12)   = 22
    name: 'Default',
    layout: [
  ...
  {
    // x:0-13:  Stocks(h=14) + Hardware(h=8)            = 22
    // x:14-18: Spotify(h=9) + Weather(h=5) + Hardware(h=8) = 22
    // x:19-23: Spotify(h=9) + Sound(h=5)   + Hardware(h=8) = 22
    name: 'Stocks Focus',
    layout: [
  ...
  {
    // x:0-9:   Spotify(h=17) + Sound(h=5)     = 22
    // x:10-16: Weather(h=10) + Hardware(h=12) = 22
    // x:17-23: Stocks(h=10)  + Hardware(h=12) = 22
    name: 'Media',
    layout: [
  ...
  {
    // x:0-7:   Hardware(h=12) + Spotify(h=10) = 22
    // x:8-15:  Hardware(h=12) + Weather(h=10) = 22
    // x:16-23: Stocks(h=12)   + Sound(h=10)   = 22
    name: 'System',
    layout: [
